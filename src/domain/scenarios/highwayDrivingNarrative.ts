...
export const highwayDrivingNarrative: StoryStep[] = [
  ...
  {
    title: "👤 TRANSITION: The Human Element",
    body: "<strong>Systems are designed for perfection. People are not.</strong><br><br>Let's see how a single moment of distraction tests our entire defense.",
    focusIds: ["hz-highway", "te-loss-control"],
  },

  // 4. (Old 6) PREVENTION: Intoxication
  {
  ...
  // 14. (Old 13) MITIGATION: Occupant Protection
  {
  ...
  // 15. (Old 3) TRANSITION TO SUCCESS STORIES
  {
  ...
  // 16. (Old 4) PREVENTION: Weather & Visibility
  {
  ...
  // 17. (Old 7) PREVENTION: Maintenance
  {
  ...
  // 19. (Old 19) CULTURE WIN: Maintenance
  {
  ...
  // 20. (Old 20) CULTURE WIN: Seatbelt
  {
