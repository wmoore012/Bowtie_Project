...
export const highwayDrivingNarrative: StoryStep[] = [
  ...
  // 3. (Was 14) TRANSITION TO SUCCESS STORIES
  {
  ...
  // 4. (Was 4) PREVENTION: Weather & Visibility
  {
  ...
  // 6. (Was 3) PREVENTION: Intoxication
  {
  ...
  // 7. (Was 5) PREVENTION: Maintenance
  {
  ...
  // 19. (Was 19) CULTURE WIN: Maintenance
  {
  ...
  // 20. (Was 20) CULTURE WIN: Seatbelt
  {
